...
function onSubmit(e){
    ...
    if(id){
        axios.put(`https://crudcrud.com/api/bcaa1d4d2b774adfbb47251ca06028a1/appointmentData/${id}`,obj)
        .then ( (res) => {
...
window.addEventListener("DOMContentLoaded",() => {
    axios.get('https://crudcrud.com/api/bcaa1d4d2b774adfbb47251ca06028a1/appointmentData')
    .then( (res) => {
